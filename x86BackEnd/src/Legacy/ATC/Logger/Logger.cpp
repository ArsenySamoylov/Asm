...
void Logger::log_dup_console(const char* format, ...)
    {

    va_list for_log;
    va_list for_console;
   
    va_start(for_log,     format);
    va_start(for_console, format);

    vfprintf (my_log, format, for_log);
     vprintf (        format, for_console);
