# В кратце
Данный репозиторий является продолжением моего проекта по созданию компилятора для собственного простого языка программирования. Данная часть посвящена Backend`у для х86 архитектуры.
...
<details>
<summary> Генерируемы ассемблерный файл для данной программы </summary>
