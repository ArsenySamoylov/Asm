...
static void DrawWindow (sf::RenderWindow* window, const pixel_color* color_array, 
                        unsigned width, unsigned height);

static void DrawPixel  (sf::RenderWindow* window, unsigned x_coord, unsigned y_coord, 
