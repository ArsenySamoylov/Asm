...
.START:
 ...
 1a0:	b8 00 00             	mov    ax, 0x0 .data ; 
 1a3:	8e d8                	mov    ds,ax  ; AX = 5298
 1a5:	8e c0                	mov    es,ax  ; DS = ES = 5298

 1a7:	e8 6a 00             	call   0x214    ; first function
 
 1aa:	b4 09                	mov    ah,0x9   ;
 1ac:	ba 36 01             	mov    dx,0x136 ; "Enter password: "
 1af:	cd 21                	int    0x21     ; Dos.displayStr (DS:0x136)

 1b1:	8c c8                	mov    ax,cs    ;
 1b3:	8e d8                	mov    ds,ax    ; DS = CS = 52AF

 1b5:	b4 0a                	mov    ah,0xa   ; 
 1b7:	ba 4f 00             	mov    dx,0x4f  ;
 1ba:	cd 21                	int    0x21     ; Dos.GetStr (DS:0x4f), max = 13 

1bc:	0f b6 1e 50 00       	movzx  bx,BYTE PTR ds:0x50 ; BX = number of chars
 1c1:	bf 09 01             	mov    di,0x109            ; DI = 
 1c4:	be 51 00             	mov    si,0x51             ; SI = (looks like password add)
 1c7:	e8 38 01             	call   0x302               ; after call, my password after lazy dog

 1ca:	81 c3 09 01          	add    bx,0x109                     ; BX  = 10C
 1ce:	26 c6 07 00          	mov    BYTE PTR es:[bx],0x0         ; ES:[BX] = 0, remove ENTER symbol
 1d2:	26 c6 47 01 24       	mov    BYTE PTR es:[bx+0x1],0x24    ; PUT $ after my password
 
 1d7:	8c c0                	mov    ax,es    ; DS = ES = 5298
 1d9:	8e d8                	mov    ds,ax    ;

 1db:	b4 09                	mov    ah,0x9   ;
 1dd:	ba 5a 01             	mov    dx,0x15a ; \_(:<)_/
 1e0:	cd 21                	int    0x21     ; Dos.displayStr (DS:0x15A)

 1e2:	b9 10 00             	mov    cx,0x10  ; 
 1e5:	be 5d 01             	mov    si,0x15d ; "JAVA IS THE TOP"
 1e8:	bf 09 01             	mov    di,0x109 ; String addres after lazy dog

 1eb:	f3 a6                	repz cmps BYTE PTR ds:[si],BYTE PTR es:[di]
 1ed:	eb 12                	jmp    0x201
 
 PASSWORD BUFF
 1ef:	13 00 - max input length
	... 20
    ... ; here 
    ...

; Jmp here after comparison
 201:	b4 09                	mov    ah,0x9
 203:	74 05                	je     0x20a

 205:	ba 50 01             	mov    dx,0x150 ; "You Lose"

 208:	eb 03                	jmp    0x20d
 
 ;If password equal 
 20a:	ba 47 01             	mov    dx,0x147 ; "You win"
 20d:	cd 21                	int    0x21 
...
;-----------------------------------------------------
 ...
 214:	30 e4                	xor    ah,ah    ; 
 216:	cd 1a                	int    0x1a     ; read the clock

 218:	0f b6 c1             	movzx  ax,cl     ; AX = CL, (CX - high number of clock)  
 ...
 22d:	e8 ba 00             	call   0x2ea ; 1.1
 230:	e8 01 00             	call   0x234 ; 1.2
...
Second function
 ...
 304:	84 c0                	test   al,al ; if al == 0, jmp 0x312
 306:	74 0a                	je     0x312, al==);

 308:	e8 08 00             	call   0x313, .al!=0
